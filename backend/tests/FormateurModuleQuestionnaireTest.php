...
final class FormateurModuleQuestionnaireTest extends TestCase
{
    ...
    {
        $stmt = $this->db->prepare(
            'INSERT INTO module_questionnaires (module_id, questionnaire_id, questionnaire_token, total_questions, last_synced_at)
             VALUES (:module_id, :questionnaire_id, :questionnaire_token, 20, NULL)'
        );
        $stmt->execute([
            'module_id' => $moduleId,
