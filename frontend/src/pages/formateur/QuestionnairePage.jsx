...
function ErrorState({ message }) {
  return (
    ...
    >
      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-rose-50 text-rose-600 shadow-[0_10px_24px_rgba(15,23,42,0.10)] dark:bg-slate-950 dark:text-white dark:shadow-[0_16px_36px_rgba(15,23,42,0.22)]">
      ...
      <div className="mt-8 flex flex-wrap items-center gap-3">
        <Link
          ...
          className="hover-action inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-sky-500 via-blue-600 to-blue-700 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:brightness-105 dark:shadow-none"
        >
        ...
        <Link
          to="/formateur"
          className="hover-action inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-300 hover:bg-slate-50"
        >
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        {questionnaire?.module_code ? (
          <span className="hover-badge rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-semibold text-slate-500" data-tooltip="Code du module">
            {questionnaire.module_code}
          </span>
        ) : null}
      </div>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-3">
        <div className="hover-card rounded-[24px] border border-white/70 bg-white/76 px-5 py-5 text-center">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.99 }}
        onClick={onStart}
          className="hover-action mt-8 inline-flex items-center gap-2 rounded-full bg-[linear-gradient(135deg,#2563eb,#06b6d4)] px-6 py-3 text-sm font-semibold text-white shadow-[0_18px_40px_rgba(37,99,235,0.22)]"
      >
    ...
    >
      <div className="mx-auto flex max-w-xl flex-col items-center text-center">
        ...
        <div className="mt-8 grid w-full gap-4 sm:grid-cols-3">
          <div className="hover-card rounded-[24px] border border-white/70 bg-white/74 px-5 py-5">
  ...
  if (!canSubmit || hasSubmitted) {
    return (
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[linear-gradient(135deg,#eff6ff,#f8fafc_42%,#ecfeff)] px-6 py-10">
        ...
        <CompletionPanel
          score={score}
          title={hasSubmitted ? 'Merci, votre questionnaire est envoye' : 'Questionnaire deja soumis'}
          description={
            hasSubmitted
            ...
            {!hasStarted ? (
              ...
              >
                ...
                <QuestionnaireNavigation
                  ...
                  onBack={handleGoToPreviousQuestion}
